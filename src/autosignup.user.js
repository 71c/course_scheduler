...
(function() {
    ...
    var baseURL = "https://sis.uit.tufts.edu/psp/paprd/EMPLOYEE/EMPL/h/";
        ...
        return function(callback) {
            ...
            waitFor(function() {
                ...
                for (var classNum of classNums) {
                    var inputBubbleOrSpan = jQuery('td:contains(' + classNum + ')')[0].parentElement.children[6].children[0];
    ...
    function addClasses(info) {
        var functions = info.classes.map(classInfo =>
    ...
    var searchSearch = "?tab=TFP_CLASS_SEARCH"; // #class_search
    var homeSearch = "?tab=DEFAULT";
