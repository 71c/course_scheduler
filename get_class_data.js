`
{
	...
	number: e.children[0].childNodes[2].nodeValue,
	description: e.children[1].innerText,
...
a table is
table = e.children[2].children[1].children[i].firstChild

type is
table.children[1].innerText

list of sections is
sections = table.children[3].children

a section's attributes is
section = sections[j].children

sectionName (Section):
section[0].childNodes[0].nodeValue.trim()

classNumber (Class No.):
section[1].textContent

session (Session):
section[2].textContent

lazy get         Day, Times and Locations
section[3].firstElementChild.firstElementChild.textContent


dayTimeLocation = section[3].firstElementChild.children[0]
timesAndCampus = Array.prototype.slice.call(dayTimeLocation.children).map(e=>e.textContent)
...
faculty (Faculty):
section[3].firstElementChild.children[1].innerText

credit (Credit):
section[4].textContent

status (Status):
section[5].firstElementChild.alt.split(' ')[0]
`
